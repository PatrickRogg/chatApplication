...
public class ChatPDU implements Serializable {
	 ...
	 * 
	 * @param userName
	 *          Client, der Login-Confirm-PDU sendet
	 * @param receivedPdu
	 *          Empfangene PDU
	 * @return Erzeugte PDU
	 */
	public static ChatPDU createLoginConfirmActionPdu(String userName,
			ChatPDU receivedPdu) {
	 ...
	 * 
	 * @param userName
	 *          Client, der Logout-Confirm-PDU sendet
	 * @param receivedPdu
	 *          Empfangene PDU
	 * @return Erzeugte PDU
	 */
	public static ChatPDU createLogoutConfirmActionPdu(String userName,
			ChatPDU receivedPdu) {
	 ...
	 * 
	 * @param userName
	 *          Client, der Chat-Message-Confirm-PDU sendet
	 * @param receivedPdu
	 *          Empfangene PDU
	 * @return Erzeugte PDU
	 */
	public static ChatPDU createChatMessageConfirmActionPdu(String userName,
			ChatPDU receivedPdu) {
